...
const MyParcels = () => {
  ...
  const handleDeleteConfirm = (id) => {
    toast.warn(
      ({ closeToast }) => (
        <div className="p-2">
          <p className="font-bold text-sm mb-3 text-base-content">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-neutral text-neutral-content p-8 rounded-[3rem] relative overflow-hidden flex flex-col justify-center shadow-2xl">
          ...
          <p className="mt-4 opacity-70 max-w-sm font-medium relative z-10">
            Track, manage, and pay for your deliveries across the Masakkali
            network in real-time.
          </p>
          <div className="mt-8 flex gap-3 relative z-10">
            <Link
              to="/sendParcel"
              className="btn btn-primary rounded-2xl px-8 font-black italic uppercase"
            >
              Send a Parcel
            </Link>
          </div>
        ...
        <div
          className="bg-primary/10 border border-primary/20 p-8 rounded-[3rem] flex flex-col justify-between group cursor-pointer hover:bg-primary/20 transition-all shadow-xl shadow-primary/5"
          onClick={() => copyAndNavigate(myParcels[0].trackingId)}
        >
          <div>
      ...
      <div className="bg-base-100 rounded-[3rem] shadow-2xl shadow-primary/5 border border-base-content/5 overflow-hidden">
        <div className="p-8 border-b border-base-content/5">
          <p className="text-[11px] font-black uppercase tracking-[0.3em] opacity-30 italic">
            Click Tracking ID to copy & navigate
          </p>
        </div>
                  ...
                  >
                    ...
                    <td className="pl-10 py-7">
                      <div className="flex items-center gap-5">
                        ...
                        <div>
                          <div className="font-black text-base uppercase tracking-tight italic">
                            {parcel.title}
                          </div>
                          <button
                    ...
                    <td>
                      <div className="flex items-center gap-4 text-xs font-bold italic">
                        <span className="bg-base-200 px-3 py-1 rounded-lg">
                          {parcel.senderRegion}
                        </span>
                        <FaMapMarkerAlt
        ...
        {myParcels.length === 0 && (
          <div className="py-24 text-center">
            ...
            <Link
              ...
              className="btn btn-link no-underline font-bold text-primary mt-2"
            >
              Book your first parcel now
            </Link>
          </div>
        )}
      </div>
